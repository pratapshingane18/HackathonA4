    ...
    <div className="bg-white rounded-lg shadow-md mx-2 my-4 p-4 w-full sm:w-1/2 md:w-1/3 lg:w-1/4">
      ...
      <div className="flex flex-wrap items-center">
        <div className="w-full sm:w-1/2">
          <p className="text-sm text-gray-500 mb-1">Year: {course.year}</p>
          <p className="text-sm text-gray-500 mb-1">Elective: {course.elective}</p>
        </div>
        <div className="w-full sm:w-1/2">
          <p className="text-sm text-gray-500 mb-1">Credits: {course.credits}</p>
        </div>
      </div>
    </div>
  );
